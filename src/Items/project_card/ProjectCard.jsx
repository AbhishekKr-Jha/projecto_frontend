...
export default function ProjectCard({
  ...
  return (
    <>
     ...
     {githubLink?.length>0  &&   <span  className=" hover:bg-slate-900 cursor-pointer rounded-full p-[6px]"  >
                <svg
                  viewBox="0 0 24 24"
                  height="24"
                  width="24"
            ...
            {liveLink?.length>0 &&   <span  className=" text-[14px]  cursor-pointer "    >Show Live</span>  }
