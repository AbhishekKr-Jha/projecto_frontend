    ...
    <>
      ...
      <section className=" element-Wrapper   pt-[55px]   px-2 md:px-7">
        <div className="my-5 md:mt-10 sm:ml-6  xl:ml-20    flex flex-wrap gap-5 gap-y-7 md:gap-y-10 md:gap-x-20 items-start md:items-center justify-start  text-[15px] sm:text-xl lg:text-[21px] ">
          <div className="flex gap-3 gap-y-10 md:gap-x-12 ">
            ...
            <div className=" flex flex-col items-start gap-0   ">
              ...
              <div className="flex mt-7  gap-8 ">
                <span
                  onClick={() => redirectLink(userLoginDetails.github)}
                  className="w-[7.5vw] max-w-[35px]  bg-white rounded-md cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out "
                >
                  <img src={github} className="" alt="loading..." />
                </span>
                <span
                  type="button"
                  onClick={() => redirectLink(userLoginDetails.linkedin)}
                  className="w-[9.7vw] max-w-[44px] rounded-md cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out"
                >
                  <img src={linkedin} alt="loading..." />
                </span>
                <span
                  onClick={() => redirectLink(userLoginDetails.instagram)}
                  className="w-[9.7vw] max-w-[44px] rounded-md cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out"
                >
          ...
          <FollowModal
            data={userLoginDetails.following}
          ...
          <FollowModal
            data={userLoginDetails.followers}
          ...
          <div className="my-2  w-full flex justify-center gap-12 md:gap-20 text-sm md:text-base  ">
            ...
            >
              ...
              {totalUserProjects > 0 ? "More" : "First"} Project
            </NavLink>
